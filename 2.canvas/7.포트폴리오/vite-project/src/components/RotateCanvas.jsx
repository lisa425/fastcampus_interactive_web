...
import { Bodies, Composite, Engine, Mouse, MouseConstraint, Render, Runner, Events } from 'matter-js'
...
const RotateCanvas = () => {
  ...
  useEffect(() => {
    //렌더링이 모두 끝난 이후 matter.js관련 코드 실행
