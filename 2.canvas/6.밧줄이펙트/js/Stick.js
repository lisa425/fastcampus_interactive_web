export default class Stick{
    constructor(p1, p2){
        ...
        this.length = this.startPoint.pos.dist(this.endPoint.pos) //original length
        this.tension = 0.3
    }
    ...
    update(){
        ...
        if(!this.startPoint.pinned){
            this.startPoint.pos.x += offsetX * 0.5 * m1
            this.startPoint.pos.y += offsetY * 0.5 * m1
        }

        if(!this.endPoint.pinned){
            this.endPoint.pos.x -= offsetX * 0.5 * m2
            this.endPoint.pos.y -= offsetY * 0.5 * m2
        }
    }
