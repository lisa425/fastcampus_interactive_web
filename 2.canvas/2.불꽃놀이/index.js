...
class Canvas extends CanvasOption {
    constructor(){
        //CanvasOption의 constructor 내 변수 사용 가능
        super(); 
        this.tails = []
        this.particles = []
        this.sparks = []
    ...
    createTail(){
        ...
        const color = randomNumBetween(0,360)
    ...
    createParticles(x, y, color){
        ...
        for(let i=0; i<PARTICLE_NUM; i++){
            ...
            const _colorDeg = randomNumBetween(-20,20) + color 
        ...
        const frame = () => {
            ...
            this.particles.forEach((particle,index) => {
                ...
                if(particle.opacity < 0){
                    //opacity가 0인(보여지지 않는) 파티클은 파티클 배열에서 제거한다.
                    //화면에 보여지지 않는 파티클을 제거하여 성능을 개선.
